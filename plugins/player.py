# Deepanshu Meena // @Deepanshu_Meena09
import os
import aiofiles
import aiohttp
import ffmpeg
...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    draw.text(
        (190, 670),
        f"Powered By: Deepanshu Meena (@Deepanshu_Meena09)",
        (255, 255, 255),
        font=font,
    )
    img.save("final.png")
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/d7b75110ec6c2b5efd233.jpg"
